...
export default function DashboardPanel({ title, description, children, className = '' }: DashboardPanelProps) {
  return (
    <section
      className={`flex flex-col overflow-hidden rounded-2xl border border-slate-200/85 bg-white shadow-[0_1px_2px_rgba(30,45,77,0.05),0_8px_28px_-12px_rgba(30,45,77,0.09)] ${className}`}
    >
