  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start gap-4">
        <button onClick={() => navigate(-1)} className="mt-1 rounded-lg border border-gray-200 p-2 text-gray-500 hover:bg-gray-50 hover:text-gray-700">
          <ArrowLeft className="h-5 w-5" />
        </button>
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-gray-900">Richiedi Emissione Polizza</h1>
          <p className="mt-1 text-sm text-gray-500">
            Dal preventivo <span className="font-medium text-gray-700">{quote.numero}</span>
          </p>
        </div>
      </div>

      {/* Pre-filled quote data */}
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="card p-6">
          ...
          <dl className="space-y-3 text-sm">
            ...
            <div>
              <dt className="text-xs font-medium text-gray-500">Stato</dt>
      ...
      <form onSubmit={handleSubmit} className="card p-6 space-y-5">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-gray-500">Dati Richiesta Polizza</h3>

        <div>
          <label htmlFor="note_struttura" className="mb-1 block text-sm font-medium text-gray-700">
        ...
        <div>
          <label htmlFor="payment-receipt" className="mb-1 block text-sm font-medium text-gray-700">
