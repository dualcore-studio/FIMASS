          ...
          <div className="mb-4 w-full shrink-0 flex justify-center px-2 sm:mb-5">
            <div className="relative flex w-full max-w-[min(100%,92vw,580px)] justify-center">
              ...
              <img
                ...
                className="relative z-[1] h-auto w-full max-h-[min(28dvh,180px)] sm:max-h-[min(32dvh,220px)] object-contain object-center bg-transparent [image-rendering:auto] drop-shadow-[0_10px_36px_rgba(15,23,42,0.12),0_2px_8px_rgba(11,78,162,0.08)] transition-transform duration-300 ease-out motion-safe:hover:scale-[1.01]"
                decoding="async"
              />
            </div>
          </div>
